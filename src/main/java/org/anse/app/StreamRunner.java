...
public class StreamRunner {
    public static final String CHECKPOINT_DIR = "file:///Users/sethurama/DEV/LM/cric-pred/flink-score-pub/checkpoints/c115";

    public static void main(String[] args) throws Exception {
        // todo - move to json config
        // remove checkpointing logic for testing
        Configuration config = new Configuration();
        config.setString("execution.checkpointing.interval", "30000");
        config.setString("state.checkpoints.dir", CHECKPOINT_DIR);
